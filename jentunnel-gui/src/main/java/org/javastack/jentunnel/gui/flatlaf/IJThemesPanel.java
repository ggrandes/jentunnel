...
package org.javastack.jentunnel.gui.flatlaf;

// https://github.com/JFormDesigner/FlatLaf/
// flatlaf-demo/src/main/java/com/formdev/flatlaf/demo/intellijthemes
...
import org.javastack.jentunnel.gui.GlobalSettings;
...
public class IJThemesPanel extends JPanel {
	...
	public IJThemesPanel() {
		...
		saveButton.setIcon(new FlatSVGIcon("flatlaf/download.svg")); // com/formdev/flatlaf/demo/icons/download.svg
		sourceCodeButton.setIcon(new FlatSVGIcon("flatlaf/github.svg")); // com/formdev/flatlaf/demo/icons/github.svg
		...
		themesList.setCellRenderer(new DefaultListCellRenderer() {
			...
			public Component getListCellRendererComponent(JList<?> list, Object value, int index,
				...
				if (title != null)
					c.setBorder(
							new CompoundBorder(new ListCellTitledBorder(themesList, title), c.getBorder()));
				return c;
			}
	...
	private void updateThemesList() {
		...
		themes.add(new IJThemeInfo("Flat Light", null, null, null, null, null, null,
				FlatLightLaf.class.getName()));
		themes.add(new IJThemeInfo("Flat Dark", null, null, null, null, null, null,
				FlatDarkLaf.class.getName()));
		themes.add(new IJThemeInfo("Flat IntelliJ", null, null, null, null, null, null,
				FlatIntelliJLaf.class.getName()));
		themes.add(new IJThemeInfo("Flat Darcula", null, null, null, null, null, null,
	...
	private void saveTheme() {
		...
		if (fileChooser
				.showSaveDialog(SwingUtilities.windowForComponent(this)) != JFileChooser.APPROVE_OPTION)
			return;
	...
	private void showInformationDialog(String message, Exception ex) {
		JOptionPane.showMessageDialog(SwingUtilities.windowForComponent(this),
				message + "\n\n" + ex.getMessage(), "FlatLaf", JOptionPane.INFORMATION_MESSAGE);
	}
	...
	private void selectedCurrentLookAndFeel() {
		...
		String theme = UIManager.getLookAndFeelDefaults().getString(GlobalSettings.THEME_UI_KEY.get());
		...
		if (theme != null && theme.startsWith(GlobalSettings.RESOURCE_PREFIX)) {
			String resourceName = theme.substring(GlobalSettings.RESOURCE_PREFIX.length());
			test = ti -> Objects.equals(ti.resourceName, resourceName);
		} else if (theme != null && theme.startsWith(GlobalSettings.FILE_PREFIX)) {
			File themeFile = new File(theme.substring(GlobalSettings.FILE_PREFIX.length()));
	...
	private void initComponents() {
		...
		// ======== toolBar ========
		{
			...
			// ---- sourceCodeButton ----
			sourceCodeButton.setToolTipText(
