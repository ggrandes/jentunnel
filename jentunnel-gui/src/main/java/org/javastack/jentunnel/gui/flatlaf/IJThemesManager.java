...
class IJThemesManager {
	private static final Logger log = LoggerFactory.getLogger(IJThemesManager.class);
	...
	void loadBundledThemes() {
		...
		try (Reader reader = new InputStreamReader(getClass().getResourceAsStream("/flatlaf/themes.json"),
		...
		for (Map.Entry<String, Object> e : json.entrySet()) {
			...
			bundledThemes.add(new IJThemeInfo(name, resourceName, license, licenseFile, sourceCodeUrl,
	...
	void loadThemesFromDirectory() {
		...
		log.info("Finding themes in: {}", directory);
